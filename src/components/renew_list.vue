...
<script>
    export default {
        ...
        methods: {
            show (index) {
                this.$router.push({ name:'renewedit', path: '/renewedit',params: { data_id: this.data_list[index].id }  })
            },
            remove (index) {
                this.axios.post(this.http_url+'/Car/data_del?source=renew&id='+this.data_list[index].id)
                .then((res)=>{
        ...
        created () {
            this.axios.post(this.http_url+'/Car/data_select?source=renew')
            .then((res)=>{
